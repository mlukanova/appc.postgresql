...
module.exports = {
  ...
  admin: {
    ...
    validEmails: ['mlukanova@axway.com']
  },

  // you can generally leave this as-is since it is generated for each new project you created.
  session: {
    encryptionAlgorithm: 'aes256',
    encryptionKey: 'pzlIV7GXSdE5uKIhoyhY8gZd03RVq50Ph5lziDd7i84=',
    signatureAlgorithm: 'sha512-drop256',
    signatureKey: 'aaaHx4Xk3aU5HKKOeFgIr8zxBfpxgKExSdzdzV+LlJdtXVERqawMwVwAhByDjadUSxVTZtdWxVDD3O/HVRqxvQ==',
    secret: 'BmaYoosECOHvz47JFG9X/ItSJSZt8e+2', // should be a large unguessable string
  ...
  cookieSecret: 'l5loN6SSrgp3Rd2DyrolV3bUbhx926Ne',
